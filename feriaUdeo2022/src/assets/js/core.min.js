...
! function(i) {
    i.fn.parallax = function() {
        ...
        return this.each(function(t) {
            ...
            var r = i(this).prepend('<div class="material-parallax parallax"><img src="assets/images/_blank.png" alt=""></div>').find(".material-parallax");
...
(function(l, F, r, m, G) {
    ...
    function w(a) {
        var b, f, e, d = a[0],
            ...
            g = a[2],
            c = a[3];
        d * c - h * g ? (b = m.sqrt(d * d + h * h), d /= b, h /= b, e = d * g + h * c, g -= d * e, c -= h * e, f = m.sqrt(g * g + c * c), e /= f, c / f * d < g / f * h && (d = -d, h = -h, e = -e, b = -b)) : b = f = e = 0;
        return [
            ["translate", [+a[4], +a[5]]],
            ["rotate", m.atan2(h, d)],
            ["skewX", m.atan(e)],
    ...
    function H(a, b) {
        ...
        ("none" == a || C.test(a)) && (a = "");
        ("none" == b || C.test(b)) && (b = "");
        a && b && !b.indexOf("matrix") && x(a).join() == x(b.split(")")[0]).join() && (f.origin = a, a = "", b = b.slice(b.indexOf(")") + 1));
        if (a || b) {
            if (a && b && a.replace(/(?:\([^)]*\))|\s/g, "") != b.replace(/(?:\([^)]*\))|\s/g, "")) f.start = w(u(a)), f.end = w(u(b));
            else
                for (a && (a = a.split(")")) && (d = a.length), b && (b = b.split(")")) && (d = b.length); ++e < d - 1;) {
                    a[e] && (h = a[e].split("("));
                    b[e] && (g = b[e].split("("));
                    c = l.trim((h || g)[0]);
                    for (var k = f.start, m = D(c, h ? h[1] : 0), n; n = m.shift();) k.push(n);
                    k = f.end;
                    for (c = D(c, g ? g[1] : 0); m = c.shift();) k.push(m)
                }
            return f
        }
    }
    ...
    function D(a, b) {
        ...
        switch (a) {
            ...
            case "scaleX":
                e = 1;
            case "scale":
                b = b ? (b = b.split(",")) && [parseFloat(b[0]), parseFloat(1 < b.length ? b[1] : "scale" == a ? e || b[0] : f + "")] : [f, f];
                break;
            case "skewX":
            case "skewY":
            case "rotate":
    ...
    l.cssNumber.transform = l.cssNumber.transformOrigin = !0;
    n && "transform" != n ? (l.cssProps.transform = n, l.cssProps.transformOrigin = n + "Origin", "MozTransform" == n ? p = { get: function(a, b) { return b ? l.css(a, n).split("px").join("") : a.style[n] }, set: function(a, b) { a.style[n] = /matrix\([^)p]*\)/.test(b) ? b.replace(/matrix((?:[^,]*,){4})([^,]*),([^)]*)/, "matrix$1$2px,$3px") : b } } : /^1\.[0-5](?:\.|$)/.test(l.fn.jquery) && (p = { get: function(a, b) { return b ? l.css(a, n.replace(/^ms/, "Ms")) : a.style[n] } })) : A && (p = {
        get: function(a, b, f) {
            var e = b && a.currentStyle ? a.currentStyle : a.style;
        ...
        set: function(a, b, f) {
            ...
            h = (d = a.currentStyle) && d.filter || e.filter || "";
            ...
            if (l.cssHooks.transformOrigin) l.cssHooks.transformOrigin.set(a, b);
                ...
                if (d = l.transform.centerOrigin) e["margin" == d ? "marginLeft" : "left"] = -(a.offsetWidth / 2) + a.clientWidth / 2 + "px", e["margin" == d ? "marginTop" : "top"] = -(a.offsetHeight / 2) + a.clientHeight / 2 + "px";
                e.left = b[4] + "px";
                e.top = b[5] + "px"
            }
        }
    ...
    l.fx.step.transform = function(a) {
        ...
        for (g = f.length; g--;) switch (c = f[g], k = e[g], q = 0, c[0]) {
            ...
            case "scale":
                q || (q = "");
                h = c[0] + "(" + m.round(1E5 * (c[1][0] + (k[1][0] - c[1][0]) * d)) / 1E5 + q + "," + m.round(1E5 * (c[1][1] + (k[1][1] - c[1][1]) * d)) / 1E5 + q + ")" + h;
                break;
            case "skewX":
            case "skewY":
            case "rotate":
        ...
        p && p.set ? p.set(b, h, 1) : b.style[n] = h
    };
...
(function(g) {
    ...
    function b(a, c, f, d) {
        ...
        e = function(b) {
            b || (b = window.event);
            b.stopPropagation || (b.stopPropagation = function() { this.cancelBubble = !0 });
            b.data = d;
            f.call(a, b)
        };
    ...
    function n(a) {
        ...
        a.data.event = a;
        a.data.onstart && a.data.onstart.call(a.data.element, a.data) || (a.preventDefault && a.data.preventDefault && a.preventDefault(), a.stopPropagation && a.data.stopPropagation && a.stopPropagation(), b(a.data.affects, "mousemove", h, a.data), b(a.data.affects, "mouseup", k, a.data))
    }
    ...
    function p(a) {
        ...
        a.data.event = a;
        a.data.onstart && a.data.onstart.call(a.data.element, a.data) || (a.preventDefault && a.data.preventDefault && a.preventDefault(), a.stopPropagation && a.data.stopPropagation && a.stopPropagation(), b(a.data.affects, "touchmove", l, a.data), b(a.data.affects, "touchend", m, a.data))
    }
    ...
    g.fn.grab = function(a, c) {
        return this.each(function() {
            var c = { move: { x: 0, y: 0 }, offset: { x: 0, y: 0 }, position: { x: 0, y: 0 }, start: { x: 0, y: 0 }, affects: document.documentElement, stopPropagation: !1, preventDefault: !0, touch: !0 };
            q(c, a);
            c.element = this;
...
! function(a, b) { "function" == typeof define && define.amd ? define(["jquery"], b) : b("object" == typeof exports ? require("jquery") : a.jQuery ? a.jQuery : a.Zepto) }(this, function(a, b) {
    a.fn.jPlayer = function(c) {
        ...
        if (arguments.length) {
            ...
            var d = this;
            this.element.bind("remove.jPlayer", function() { d.destroy() }), this._init()
        }
    ...
    c.prototype = {
        init: function() { this.options = { timeFormat: a.jPlayer.timeFormat } },
        time: function(a) {
    ...
    var d = new c;
    a.jPlayer.convertTime = function(a) { return d.time(a) }, a.jPlayer.uaBrowser = function(a) {
        var b = a.toLowerCase(),
            c = /(webkit)[ \/]([\w.]+)/,
            d = /(opera)(?:.*version)?[ \/]([\w.]+)/,
            e = /(msie) ([\w.]+)/,
    ...
    f.platform && (a.jPlayer.platform[f.platform] = !0, a.jPlayer.platform.mobile = !f.tablet, a.jPlayer.platform.tablet = !!f.tablet), a.jPlayer.getDocMode = function() { var b; return a.jPlayer.browser.msie && (document.documentMode ? b = document.documentMode : (b = 5, document.compatMode && "CSS1Compat" === document.compatMode && (b = 7))), b }, a.jPlayer.browser.documentMode = a.jPlayer.getDocMode(), a.jPlayer.nativeFeatures = {
        init: function() {
            ...
            for (this.fullscreen = a = { support: { w3c: !!d[f.w3c[0]], moz: !!d[f.moz[0]], webkit: "function" == typeof d[f.webkit[3]], webkitVideo: "function" == typeof e[f.webkitVideo[2]], ms: "function" == typeof e[f.ms[2]] }, used: {} }, b = 0, c = g.length; c > b; b++) { var h = g[b]; if (a.support[h]) { a.spec = h, a.used[h] = !0; break } }
            if (a.spec) {
                var i = f[a.spec];
                a.api = { fullscreenEnabled: !0, fullscreenElement: function(a) { return a = a ? a : d, a[i[1]] }, requestFullscreen: function(a) { return a[i[2]]() }, exitFullscreen: function(a) { return a = a ? a : d, a[i[3]]() } }, a.event = { fullscreenchange: i[4], fullscreenerror: i[5] }
            } else a.api = { fullscreenEnabled: !1, fullscreenElement: function() { return null }, requestFullscreen: function() {}, exitFullscreen: function() {} }, a.event = {}
        }
    ...
    a.jPlayer.keys = function(b) {
        ...
        options: {
            ...
            loop: !1,
            repeat: function(b) { b.jPlayer.options.loop ? a(this).unbind(".jPlayerRepeat").bind(a.jPlayer.event.ended + ".jPlayer.jPlayerRepeat", function() { a(this).jPlayer("play") }) : a(this).unbind(".jPlayerRepeat") },
            nativeVideoControls: {},
            noFullWindow: { msie: /msie [0-6]\./, ipad: /ipad.*?os [0-4]\./, iphone: /iphone/, ipod: /ipod/, android_pad: /android [0-3]\.(?!.*?mobile)/, android_phone: /(?=.*android)(?!.*chrome)(?=.*mobile)/, blackberry: /blackberry/, windows_ce: /windows ce/, iemobile: /iemobile/, webos: /webos/ },
            ...
            audioFullScreen: !1,
            keyBindings: {
                play: { key: 80, fn: function(a) { a.status.paused ? a.play() : a.pause() } },
                fullScreen: {
                    key: 70,
                    fn: function(a) {
                ...
                muted: { key: 77, fn: function(a) { a._muted(!a.options.muted) } },
                volumeUp: { key: 190, fn: function(a) { a.volume(a.options.volume + .1) } },
                volumeDown: { key: 188, fn: function(a) { a.volume(a.options.volume - .1) } },
                loop: { key: 76, fn: function(a) { a._loop(!a.options.loop) } }
            },
            verticalVolume: !1,
        ...
        _init: function() {
            ...
            if (this.element.empty(), this.status = a.extend({}, this.status), this.internal = a.extend({}, this.internal), this.options.timeFormat = a.extend({}, a.jPlayer.timeFormat, this.options.timeFormat), this.internal.cmdsIgnored = a.jPlayer.platform.ipad || a.jPlayer.platform.iphone || a.jPlayer.platform.ipod, this.internal.domNode = this.element.get(0), this.options.keyEnabled && !a.jPlayer.focus && (a.jPlayer.focus = this), this.androidFix = { setMedia: !1, play: !1, pause: !1, time: 0 / 0 }, a.jPlayer.platform.android && (this.options.preload = "auto" !== this.options.preload ? "metadata" : "auto"), this.formats = [], this.solutions = [], this.require = {}, this.htmlElement = {}, this.html = {}, this.html.audio = {}, this.html.video = {}, this.aurora = {}, this.aurora.formats = [], this.aurora.properties = [], this.flash = {}, this.css = {}, this.css.cs = {}, this.css.jq = {}, this.ancestorJq = [], this.options.volume = this._limitValue(this.options.volume, 0, 1), a.each(this.options.supplied.toLowerCase().split(","), function(b, d) {
                    ...
                    if (c.format[e]) {
                        var f = !1;
                        a.each(c.formats, function(a, b) { return e === b ? (f = !0, !1) : void 0 }), f || c.formats.push(e)
                    }
                }), a.each(this.options.solution.toLowerCase().split(","), function(b, d) {
                    var e = d.replace(/^\s+|\s+$/g, "");
                    if (c.solution[e]) {
                        var f = !1;
                        a.each(c.solutions, function(a, b) { return e === b ? (f = !0, !1) : void 0 }), f || c.solutions.push(e)
                    }
                }), a.each(this.options.auroraFormats.toLowerCase().split(","), function(b, d) {
                    var e = d.replace(/^\s+|\s+$/g, "");
                    if (c.format[e]) {
                        var f = !1;
                        a.each(c.aurora.formats, function(a, b) { return e === b ? (f = !0, !1) : void 0 }), f || c.aurora.formats.push(e)
                    }
                ...
                }, this.element.append(this.htmlElement.poster), this.internal.poster.jq = a("#" + this.internal.poster.id), this.internal.poster.jq.css({ width: this.status.width, height: this.status.height }), this.internal.poster.jq.hide(), this.internal.poster.jq.bind("click.jPlayer", function() { c._trigger(a.jPlayer.event.click) }), this.html.audio.available = !1, this.require.audio && (this.htmlElement.audio = document.createElement("audio"), this.htmlElement.audio.id = this.internal.audio.id, this.html.audio.available = !!this.htmlElement.audio.canPlayType && this._testCanPlayType(this.htmlElement.audio)), this.html.video.available = !1, this.require.video && (this.htmlElement.video = document.createElement("video"), this.htmlElement.video.id = this.internal.video.id, this.html.video.available = !!this.htmlElement.video.canPlayType && this._testCanPlayType(this.htmlElement.video)), this.flash.available = this._checkForFlash(10.1), this.html.canPlay = {}, this.aurora.canPlay = {}, this.flash.canPlay = {}, a.each(this.formats, function(b, d) { c.html.canPlay[d] = c.html[c.format[d].media].available && "" !== c.htmlElement[c.format[d].media].canPlayType(c.format[d].codec), c.aurora.canPlay[d] = a.inArray(d, c.aurora.formats) > -1, c.flash.canPlay[d] = c.format[d].flashCanPlay && c.flash.available }), this.html.desired = !1, this.aurora.desired = !1, this.flash.desired = !1, a.each(this.solutions, function(b, d) {
                    if (0 === b) c[d].desired = !0;
                    else {
                        var e = !1,
                            f = !1;
                        a.each(c.formats, function(a, b) { c[c.solutions[0]].canPlay[b] && ("video" === c.format[b].media ? f = !0 : e = !0) }), c[d].desired = c.require.audio && !e || c.require.video && !f
                    }
        ...
        _testPlaybackRate: function(a) {
            ...
            try { return "playbackRate" in b ? (b.playbackRate = c, b.playbackRate === c) : !1 } catch (d) { return !1 }
        },
        _uaBlocklist: function(b) {
            var c = navigator.userAgent.toLowerCase(),
                d = !1;
            return a.each(b, function(a, b) { return b && b.test(c) ? (d = !0, !1) : void 0 }), d
        },
        ...
        _qualifyURL: function(a) { var b = document.createElement("div"); return b.innerHTML = '<a href="' + this._escapeHtml(a) + '">x</a>', b.firstChild.href },
        ...
        tellOthers: function(b, c) {
            ...
            "string" == typeof b && (e && f.splice(1, 1), a.jPlayer.prototype.destroyRemoved(), a.each(this.instances, function() { d.element !== this && (!e || c.call(this.data("jPlayer"), d)) && this.jPlayer.apply(this, f) }))
        },
            ...
            if ("string" == typeof c)
                if (a.jPlayer.prototype.options.cssSelector[b]) {
                    if (this.css.jq[b] && this.css.jq[b].length && this.css.jq[b].unbind(".jPlayer"), this.options.cssSelector[b] = c, this.css.cs[b] = this.options.cssSelectorAncestor + " " + c, this.css.jq[b] = c ? a(this.css.cs[b]) : [], this.css.jq[b].length && this[b]) {
                        var e = function(c) { c.preventDefault(), d[b](c), d.options.autoBlur ? a(this).blur() : a(this).focus() };
        ...
        _setOption: function(b, c) {
            ...
            switch (b) {
                ...
                case "cssSelectorAncestor":
                    ...
                    break;
                case "cssSelector":
                    a.each(c, function(a, b) { d._cssSelector(a, b) });
                    break;
                case "playbackRate":
        ...
        _html_play: function(a) {
            ...
            if (this.androidFix.pause = !1, this._html_load(), this.androidFix.setMedia) this.androidFix.play = !0, this.androidFix.time = a;
                ...
                } catch (d) { return void(this.internal.htmlDlyCmdId = setTimeout(function() { b.play(a) }, 250)) }
            }
        ...
        _html_pause: function(a) {
            ...
            if (this.androidFix.play = !1, a > 0 ? this._html_load() : clearTimeout(this.internal.htmlDlyCmdId), c.pause(), this.androidFix.setMedia) this.androidFix.pause = !0, this.androidFix.time = a;
                ...
                if (c.seekable && !("object" == typeof c.seekable && c.seekable.length > 0)) throw 1;
                c.currentTime = a
            } catch (d) { return void(this.internal.htmlDlyCmdId = setTimeout(function() { b.pause(a) }, 250)) }
        ...
        _html_playHead: function(a) {
            ...
            } catch (d) { return void(this.internal.htmlDlyCmdId = setTimeout(function() { b.playHead(a) }, 250)) }
        ...
        _emulateHtmlBridge: function() {
            ...
            a.each(a.jPlayer.emulateMethods.split(/\s+/g), function(a, c) { b.internal.domNode[c] = function(a) { b[c](a) } }), a.each(a.jPlayer.event, function(c, d) {
                var e = !0;
                a.each(a.jPlayer.reservedEvent.split(/\s+/g), function(a, b) { return b === c ? (e = !1, !1) : void 0 }), e && b.element.bind(d + ".jPlayer.jPlayerHtml", function() {
...
! function(a, b) {
    jPlayerPlaylist = function(b, c, d) {
        ...
        _createListItem: function(b) {
            ...
            return d += "<a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='0'>" + b.title + (b.artist ? " <span class='jp-artist'>from " + b.artist + "</span>" : "") + "</a>", d += "</div></li>"
        },
...
window.Modernizr = function(a, b, c) {
    ...
    var d = "1.7pre",
        ...
        y = ({}).hasOwnProperty,
        z;
    C(y, c) || C(y.call, c) ? z = function(a, b) { return b in a && C(a.constructor.prototype[b], c) } : z = function(a, b) { return y.call(a, b) }, r.csstransforms = function() { return !!E(["transformProperty", "WebkitTransform", "MozTransform", "OTransform", "msTransform"]) };
    for (var H in r) z(r, H) && (v = H.toLowerCase(), e[v] = r[H](), u.push((e[v] ? "" : "no-") + v));
    e.input || G(), e.crosswindowmessaging = e.postmessage, e.historymanagement = e.history, e.addTest = function(a, b) { a = a.toLowerCase(); if (!e[a]) { b = !!b(), g.className += " " + (b ? "" : "no-") + a, e[a] = b; return e } }, A(""), j = l = null, e._enableHTML5 = f, e._version = d, g.className = g.className.replace(/\bno-js\b/, "") + " js " + u.join(" ");
    return e
}(this, this.document);
...
var CirclePlayer = function(a, b, c) {
    ...
    this.player = $(a);
    this.media = $.extend({}, b);
    this.options = $.extend(!0, {}, { supplied: "m4a, oga", cssSelectorAncestor: "#cp_container_1", cssSelector: { play: ".cp-play", pause: ".cp-pause" } }, c);
    this.cssTransforms = Modernizr.csstransforms;
    this.audio = {};
    this.dragging = !1;
    this.eventNamespace = ".CirclePlayer";
    this.jq = {};
    $.each({ bufferHolder: ".cp-buffer-holder", buffer1: ".cp-buffer-1", buffer2: ".cp-buffer-2", progressHolder: ".cp-progress-holder", progress1: ".cp-progress-1", progress2: ".cp-progress-2", circleControl: ".cp-circle-control" }, function(a, b) { d.jq[a] = $(d.options.cssSelectorAncestor + " " + b) });
    this._initSolution();
    this._initPlayer()
};
CirclePlayer.prototype = {
    ...
    _initPlayer: function() {
        ...
        this.player.bind($.jPlayer.event.ready + this.eventNamespace, function(b) {
            b.jPlayer.html.used && b.jPlayer.html.audio.available && (a.audio = $(this).data("jPlayer").htmlElement.audio);
            $(this).jPlayer("setMedia", a.media);
            a._initCircleControl()
        });
        this.player.bind($.jPlayer.event.play + this.eventNamespace, function(a) { $(this).jPlayer("pauseOthers") });
        this.player.bind($.jPlayer.event.timeupdate + this.eventNamespace, function(b) { a.dragging || a._timeupdate(b.jPlayer.status.currentPercentAbsolute) });
        this.player.bind($.jPlayer.event.progress + this.eventNamespace, function(b) {
            b = 0;
            if ("object" === typeof a.audio.buffered && 0 < a.audio.buffered.length) {
                if (0 < a.audio.duration) {
                    for (var c = b = 0; c < a.audio.buffered.length; c++) b += a.audio.buffered.end(c) - a.audio.buffered.start(c);
                    b = 100 * b / a.audio.duration
                }
            } else b = 0;
            a._progress(b)
        });
        this.player.bind($.jPlayer.event.ended + this.eventNamespace, function(b) { a._resetSolution() })
    },
    _initSolution: function() {
        this.cssTransforms ? (this.jq.progressHolder.show(), this.jq.bufferHolder.show()) : (this.jq.progressHolder.addClass(this.cssClass.gt50).show(), this.jq.progress1.addClass(this.cssClass.fallback), this.jq.progress2.hide(), this.jq.bufferHolder.hide());
        this._resetSolution()
    },
    _resetSolution: function() { this.cssTransforms ? (this.jq.progressHolder.removeClass(this.cssClass.gt50), this.jq.progress1.css({ transform: "rotate(0deg)" }), this.jq.progress2.css({ transform: "rotate(0deg)" }).hide()) : this.jq.progress1.css("background-position", "0 " + this.spritePitch + "px") },
    _initCircleControl: function() {
        var a = this;
        this.jq.circleControl.grab({
            onstart: function() { a.dragging = !0 },
            onmove: function(b) {
                b = a._getArcPercent(b.position.x, b.position.y);
    ...
    _timeupdate: function(a) {
        var b = 3.6 * a + "deg",
            c = (Math.floor(Math.round(a) * this.spriteRatio) - 1) * -this.spritePitch;
        50 >= a ? this.cssTransforms ? (this.jq.progressHolder.removeClass(this.cssClass.gt50), this.jq.progress1.css({ transform: "rotate(" + b + ")" }), this.jq.progress2.hide()) : this.jq.progress1.css("background-position", "0 " + c + "px") : 100 >= a && (this.cssTransforms ? (this.jq.progressHolder.addClass(this.cssClass.gt50), this.jq.progress1.css({ transform: "rotate(180deg)" }), this.jq.progress2.css({ transform: "rotate(" + b + ")" }), this.jq.progress2.show()) : this.jq.progress1.css("background-position", "0 " + c + "px"))
    },
    _progress: function(a) {
        var b = 3.6 * a + "deg";
        this.cssTransforms && (50 >= a ? (this.jq.bufferHolder.removeClass(this.cssClass.gt50), this.jq.buffer1.css({ transform: "rotate(" + b + ")" }), this.jq.buffer2.hide()) : 100 >= a && (this.jq.bufferHolder.addClass(this.cssClass.gt50), this.jq.buffer1.css({ transform: "rotate(180deg)" }), this.jq.buffer2.show(), this.jq.buffer2.css({ transform: "rotate(" + b + ")" })))
    },
    _getArcPercent: function(a, b) {
        var c = this.jq.circleControl.offset(),
            d = a - c.left - this.jq.circleControl.width() / 2,
            c = b - c.top - this.jq.circleControl.height() / 2,
            d = Math.atan2(c, d);
        d > -1 * Math.PI && d < -.5 * Math.PI && (d = 2 * Math.PI + d);
        return (d + Math.PI / 2) / 2 * Math.PI * 10
    },
    setMedia: function(a) {
        this.media = $.extend({}, a);
        this.player.jPlayer("setMedia", this.media)
    },
    play: function(a) { this.player.jPlayer("play", a) },
    pause: function(a) { this.player.jPlayer("pause", a) },
    destroy: function() {
